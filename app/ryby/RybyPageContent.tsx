...
// (viz app/ryby/page.tsx a app/page.tsx), ať nevznikají dvě nezávislé
// implementace stejné stránky. SEO canonical obou routes vždy míří na
// `/ryby` (viz metadata v app/ryby/page.tsx a app/page.tsx).
export default async function RybyPageContent() {
